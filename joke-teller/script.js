const newLocal = {
    speech: function (e) { this._validate(e), this._request(e); }, _validate: function (e) {
        if (!e)
            throw "The settings are undefined"; if (!e.key)
            throw "The API key is undefined"; if (!e.src)
            throw "The text is undefined"; if (!e.hl)
            throw "The language is undefined"; if (e.c && "auto" != e.c.toLowerCase()) {
...
//Passing Joke to VoiceRSS AIP
function tellMe(joke){
    console.log('tell me:', joke);
    VoiceRSS.speech({
        key: '2e7b795bb6894f6b90fa9b1a44e99d3a',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
